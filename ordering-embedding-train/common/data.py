...
class DiskDataSource_c(DataSource):
    ...
    def gen_batch(self, a, b, c, train, p_batch, max_size=10, min_size=5, seed=None,
        ...
        for i in range(p_batch * 64, (p_batch + 1) * 64):
            ...
            with open("./dataset_dblp/dataset/" + str(pre_index) + ".txt") as file: 
                ...
                if choose == 0:
                    ...
                    G_b, node_set_b = utils.sample_neigh([G_a], random.randint(2, 5))
                    ...
                    while fin != True:
                        ...
                        _G_b, _node_set_b = utils.sample_neigh([G_b], random.randint(2, 5))
